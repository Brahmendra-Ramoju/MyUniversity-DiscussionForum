...
<html>
    <head>
        <title> GITAM Discussion Forum by Batch-G </title>
    ...
    <body id="_3">
        ...
        <a href="index.php">
            <div id="log">
                <div id="i">G</div><div id="cir"></div>i<div id="ntro">GITAM Discussion Forum</div>
            </div>
        </a>
        <ul id="nav-bar">
...
<!--                                    <input type="button" value="Click here to answer." id="ans_b" >-->
        ...
        <!-- Footer -->
        <div id="footer">
            &copy; 2019 &bull; Discussion Forum By Batch-G of 3B8 Students.
        </div>
