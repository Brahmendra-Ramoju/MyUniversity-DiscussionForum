    ...
    <body id="_6">
        ...
        <div id="content">
            <div id="sf">
                <center>
                    <div class="heading">
                        <h1 class="logo"><div id="i">i</div><div id="cir">i</div><div id="ntro">GITAM Discussion Forum</div></h1>
...
//                    echo mysqli_error($conn);
        ...
        <div id="footer" style="padding:20px;">
            &copy; 2019 &bull; GITAM Discussion forum by Batch-G of 3B8 Section.
        </div>
